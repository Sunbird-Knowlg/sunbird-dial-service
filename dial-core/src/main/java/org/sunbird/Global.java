...
import org.sunbird.telemetry.TelemetryAccessEventUtil;
                ...
                call.onRedeem((r) -> {
                    try {
                        ...
                        if (!path.contains("/health")) {
                            ...
                            org.sunbird.commons.dto.Request req = mapper.convertValue(requestData,
                                    org.sunbird.commons.dto.Request.class);
